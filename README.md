...
4. **[Tahap 4: UI Level 1 List Modal](file:///home/geri/ITM/SOEDOMO/dokumentasi-soedomo/modal-style.md)**: Mengacu paten `list_pengkajian_geriatri_rajal_modal.php`.
5. **[Tahap 5: UI Level 2 Form Modal & TTD](file:///home/geri/ITM/SOEDOMO/dokumentasi-soedomo/modal-style.md)**: Mengacu paten `form_pengkajian_geriatri_rajal_modal.php` + Efisiensi Single-Entry TTD `_modalTtd`.
6. **[Tahap 6: PDF Cetak Dompdf](file:///home/geri/ITM/SOEDOMO/dokumentasi-soedomo/list-cetak.md)**: Mengacu paten `cetak_pengkajian_geriatri_rajal.php` + Kop Surat 3-Kolom Murni & Simetris (`height: 105px;`).
